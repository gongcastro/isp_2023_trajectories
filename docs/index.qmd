...
Bilinguals do not fall behind [e.g., @hoff2012dual]. **Mixed evidence** on across language pairs: English-French, Catalan-Spanish, etc.
...
Bilingual toddlers learning two languages that share more **cognates** show larger vocabulary sizes [@floccia2018introduction]
...
![](images/accumulator-diagram.png){width="90%" fig-align=center}
...
## H0: no parallel activation {.smaller}
...
## H1: parallel activation  {.smaller}
...
- On-line [@arslan2020formr]
- Inspired in CDI [@fenson1994variability]
- ~1,600 items/words (800 Catalan, 800 Spanish)
- Sub-lists of 500 items (250 Catalan / 250 Spanish)
...
![](images/ministerio.png){ width="100px"}

![](images/icrea.png){width="100px"}

![](images/nacho.jpg){width="150px"}

![](images/daniela.jpeg){width="150px"}
