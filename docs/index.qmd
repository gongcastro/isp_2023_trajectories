...
- Earliest evidence of word acquisition: **6 months** of age [@jusczyk1995infants; @bergelson2012months]
...
![Medical Xpress](images/bergelson-swingley.jpg)
...
::: {.notes}
* Leaning words is important
* Accessing a world of concepts through fairly arbitrary perceptual objects
* But it's a hard task: ambiguity, variability
...
::: info-box
<p style="text-align:center">*gos* &rarr; DOG &larr; *perro*</p>
:::

::: {.notes}
* Bilinguals face an even more difficult task
* Learning more than two labels per referent
:::
...
**Vocabulary checklist**: number/proportion of words checked by caregivers as `Understands`, and/or `Says` [e.g., CDI, @fenson1994variability]
...
::: {.notes}
* In this talk, I will focus on a particular aspect of language acquisition: lexical development
* Many ways of measuring lexical development: vocabulary size
* Vocabulary size measured using vocabulary checklists
* Caregivers fill a questionnaire indicating the words they think their child understands or produces
:::
...
English-Spanish bilinguals: **smaller English vocab. size** compared to monolinguals, but **similar total vocab. size** [@hoff2012dual]
...
::: {.notes}
* They do not seem to fall behind monolinguals, at least when both languages are summed together
* As more language pairs are tested, evidence is more mixed (advantage?)
...
Bilingual toddlers learning two **typologically close languages**: larger vocabulary sizes [@floccia2018introduction]
...
Translation equivalents are co-activated, even in monolingual situations [e.g., @costa2000cognate]
...
# Simulations: monolingual word acquisition {background-color="#003f5c"}
...
::: notes
* Threshold: theoretical number of cumulative learning instances at which the lexical representation is consolidated
* Set at 300 for simulation purposes
:::
...
# Simulations: bilingual word acquisition {background-color="#003f5c"}
...
# Testing predictions (observed data){background-color="#003f5c"}
...
# Results {background-color="#bc5090"}
...
# Discussion {background-color="#ff6361"}
